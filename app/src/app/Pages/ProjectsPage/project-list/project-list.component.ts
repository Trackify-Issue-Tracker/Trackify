...
import { ProjectSortingDetailsComponent } from '../project-sorting-details/project-sorting-details.component';
...
@Component({
  ...
  imports: [
    CommonModule,
    FormsModule,
    ProjectSortingDetailsComponent,
...
export class ProjectListComponent {
  ...
  tabs = ['All Projects', 'Current Projects', 'Complete Projects'];
  selectedTab = 0;
